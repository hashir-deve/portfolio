...
export class ProjectsComponent {
  projects = [
    {
      title: 'Omnichain Chatbot',
      desc: 'Developed AI powered demand planning chatbot that heps businesses to automate their supply chain and perform inventory and demand planning efficiently.',
    },
    {
      title: 'Telepsychiatry Site',
      desc: 'Developed a website that will help the people to reduce mental stress and access health advisor across the world',
    },
    {
